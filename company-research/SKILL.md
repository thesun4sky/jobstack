...
- 기존 캐시 확인: `~/.jobstack/company-cache/{company}-*.md` 파일이 있으면 사용자에게 알리고, 새로 분석할지 기존 리포트를 업데이트할지 확인합니다.
...
**검색어 패턴 예시:**
- `"{COMPANY} 채용공고 {POSITION} 2025 2026"`
- `"{COMPANY} CEO 신년사 2026"` / `"{COMPANY} 주주서한"`
- `"{COMPANY} 매출 영업이익 직원수"`
...
> 생성일: {TODAY} | jobstack /company-research v0.1.0
