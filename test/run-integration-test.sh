...
for lint in test-preambles.sh test-command-style.sh test-no-home-paths.sh lint-conventions.sh run-golden.sh test-fetch-diag.mjs test-wanted-verify.mjs; do
